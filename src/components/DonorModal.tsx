    ...
    <div className="space-y-6 ">
      ...
      <div className="flex items-center justify-between  gap-4 ">
        <div
          ...
          className={`flex items-center justify-center rounded-[8px] w-1/2 h-16  font-metrophobic border border-purple-900 hover:cursor-pointer transition-all duration-200 ${
